    ...
    <div class="container mt-5">
        ...
        <div class="card mb-4 shadow-lg">
            <div class="card-header bg-primary text-white">
                <i class="fas fa-plane"></i> Aircraft Management
                <a href="AddAircraft.aspx" class="btn btn-success btn-sm float-end"><i class="fas fa-plus"></i> Add New Aircraft</a>
            </div>
            <div class="card-body">
                <asp:GridView ID="gvAircrafts" runat="server" AutoGenerateColumns="False" CssClass="table table-striped">
                    <Columns>
